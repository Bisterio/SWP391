    ...
    <body>
        <div>
            <%
                ...
                if (currentCourse.getStatus().equalsIgnoreCase("Active")) {
            %>
            <nav class="sidebar">
                <header>
            ...
            <div class="btn__submit">
                <a href="CourseController?action=DeleteCourseEdit&CourseToDelete=<%= currentCourse.getCourseId()%>"><button class="enrollBtn">Close to edit</button></a>
            </div>
            <section class="banner">
                <div class="banner__content">
                    ...
                    <div class="input__sectionName" style="border: none;">
                        <%= currentCourse.getCourseName()%>
                    </div>
                    <div>
                        <label for="input__duration">Duration: <%= currentCourse.getDuration()%> hour(s)</label>
                    </div>
                    ...
                    <div class="accordion-item">
                        <h2 class="accordion-header" id="panelsStayOpen-heading<%= section.getSectionId()%>">
                            <button
                                ...
                                >
                                <div class="section__Name__input" style="display: flex;">
                        ...
                        <div
                            ...
                            <div class="accordion-body">
                                <ol>
                                    ...
                                    %>
                                    <li class="topic__Name__input" style="border: none;width: 100%;">
                                        <%= topic.getTopicName()%>
                                    </li>
                                    <%
                                        }
            ...
            <div class="addCourse__title">Edit course</div>
            <div class="btn__submit">
                <a href="CourseController?action=ReopenCourseEdit&CourseToReopen=<%= currentCourse.getCourseId()%>"><button class="enrollBtn">Open to all</button></a>
            </div>
            <section class="banner">
                <div class="banner__content">
                    <!-- <h3>Name of the course</h3> -->
                            ...
                            <div class="accordion-body">
                                <ol>
                                    ...
                                    <form action="MainController" method="POST">
                                        ...
                                        <input class="input__topic" type="text" name="txtTopicName" placeholder="Input topic's name" required>
