                                        ...
                                        <div class="table-responsive">
                                            <table class="table table-xs mb-0">
                                                ...
                                                <tbody>
                                                    ...
                                                    <form target="_blank" action="StudentInCourseController" method="POST">
                                                        <input type="hidden" name="action" value="ViewStudentInCourse">
                                                        <tr>

                                                            <td><input style="width:50%;border: none;" type="text" name="courseId" value="${course.getCourseId()}" readonly></td>
                                                            <td><input style="width:50%;border: none;" type="text" name="courseName" value="${course.getCourseName()}" readonly></td>
                                                            
                                                            <td><c:out value="${course.getStatus()}"></c:out></td>
