                                    ...
                                    <div class="active-member">
                                        <div class="table-responsive">
                                            <table class="table table-xs mb-0">
                                                ...
                                                <tbody>
                                                    <c:forEach var="crs" items="${requestScope.COURSE_LIST}">
                                                        <tr>
                                                            <td><c:out value="${crs.getCourseId()}"></c:out></td>
                                                            <td><c:out value="${crs.getCourseName()}"></c:out></td>
                                                            <td><c:out value="${crs.getDescription()}"></c:out></td>
                                                            <td><c:out value="${crs.getStatus()}"></c:out></td>
                                                            <td><c:out value="${crs.getPrice()}"></c:out></td>
                                                            <td><c:out value="${crs.getDuration()}"></c:out></td>


                                                                <td>
                                                                <c:if test="${crs.getStatus() == 'Active'}">
                                                                    <c:url var="mylink" value="CourseControllerAdmin">
                                                                        <c:param name="id" value="${crs.getCourseId()}"></c:param>
                                                                        <c:param name="status" value="${crs.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
                                                                    </c:url>
                                                                    <a class="btn btn-primary" href="${mylink}">Block</a>
                                                                </c:if>
                                                                    <c:if test="${crs.getStatus() == 'Inactive'}">
                                                                    <c:url var="mylink" value="CourseControllerAdmin">
                                                                        <c:param name="id" value="${crs.getCourseId()}"></c:param>
                                                                        <c:param name="status" value="${crs.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
