            ...
            ***********************************-->
            <div class="content-body">
                <div class="container-fluid mt-3">
                    ...
                    <form name="Register" method="POST" action="MainControllerAdmin" id="authorRegister">
                        ...
                        <div class="row">
                            <div class="col-lg-12" >
                                ...
                                <div class="col-6">
                                    ...
                                    <input type="text" name="txtemail" class="form-control" placeholder="Author email" required>
                                </div>
                                <p></p>
                                <div class="col-6">
                                    <span class="label-input100">Password <span style="color: red">*</span></span>
                                    <input type="password" name="txtpassword" class="form-control" placeholder="Author password" required>
                                </div>
                                <p></p>
                                <div class="col-6">
                                    <span class="label-input100">First name <span style="color: red">*</span></span>
                                    <input type="text" name="txtfirstName" class="form-control" placeholder="Author firstname" required>
                                </div>
                                <p></p>
                                <div class="col-6">
                                    <span class="label-input100">Last name <span style="color: red">*</span></span>
                                    <input type="text" name="txtlastName" class="form-control" placeholder="Author lastname" required>
                                </div>
                                <p></p>
                                <div class="col-6">
                                    <span class="label-input100">Phone number <span style="color: red">*</span></span>
                                    <input type="text" name="txtphoneNumber" class="form-control" placeholder="Ex: 0123456789" required>
                                </div>
                                <p></p>

                                <div class="col-6" >
                                    <input onclick="submit_form('authorRegister')" style="position: right" class="btn btn-primary m-1" type="submit" name="action" value="Add author"><br/>
                                </div>
                                <div class="col-6" style="color: red" >
                                    ${requestScope.errorAuthor}
                                </div>
