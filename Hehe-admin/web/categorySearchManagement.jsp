            ...
            <div class="content-body">
                ...
                <div class="container-fluid mt-3">
                    <div style="display: flex; justify-content: space-between" >
                        ...
                        <span>
                            <a class="btn btn-primary" href="addCategory.jsp">Add</a>
                        </span>
                    </div>
                                    ...
                                    <div class="active-member">
                                        <div class="table-responsive">
                                            <table class="table table-xs mb-0">
                                                ...
                                                <tbody>
                                                    <c:forEach var="searchCate" items="${requestScope.searchCate}">
                                                        <form action="CategoryController" method="POST">
                                                        <input type="hidden" name="action" value="UpdateCategory">
                                                        <tr>
                                                            <td><input style="width:50%;border: none;" type="text" name="cateId" value="${searchCate.getCategoryId()}" readonly></td>
                                                            <td><input style="width:100%;border: none;" type="text" name="cateName" value="${searchCate.getCategoryName()}" required></td>
                                                            <td><input style="width:100%;border: none;"  type="text" name="cateDes" value="${searchCate.getDescription()}" required></td>
                                                            <td><c:out value="${searchCate.getStatus()}"></c:out></td>



                                                                <td>
                                                                <c:if test="${searchCate.getStatus() == 'Active'}">
                                                                    <c:url var="mylink" value="CategoryController">
                                                                        <c:param name="id" value="${searchCate.getCategoryId()}"></c:param>
                                                                        <c:param name="status" value="${searchCate.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
                                                                    </c:url>
                                                                    <a class="btn btn-primary" href="${mylink}">Block</a>
                                                                </c:if>
                                                                <c:if test="${searchCate.getStatus() == 'Inactive'}">
                                                                    <c:url var="mylink" value="CategoryController">
                                                                        <c:param name="id" value="${searchCate.getCategoryId()}"></c:param>
                                                                        <c:param name="status" value="${searchCate.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
