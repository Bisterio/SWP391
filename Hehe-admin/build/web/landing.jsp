                    ...
                    <div class="col-sm-6 col-md-6 col-lg-4 col-xl-3">
                        <div class="card">
                            ...
                            <div class="card-content">
                                ...
                                %>
                                <h4 style="color: green; font: bold">Opened</h4>
                                <%
                                } else {
                                %>
                                <h4 style="color: red; font: bold">Closed</h4>
                                <%
                                    }
                                %>
                                ...
                                <form style="margin-bottom: 10px;" action="StudentInCourseController" method="POST">
                                    ...
                                    <input  class="buttonViewStudentCourse" type="submit" value="View Students">
                                </form>
                                <div class="card-content-detail">
                                    ...
                                    <%
                                        if (course.getCourseStatus().equalsIgnoreCase("Active")) {
                                    %>
                                    <a href="CourseController?action=DeleteCourse&CourseToDelete=<%= course.getCourseId()%>"><button class="buttonDeleteCourse" type="button">Close</button></a>
                                    <%
                                    } else {
                                    %>
                                    <a href="CourseController?action=ReopenCourse&CourseToReopen=<%= course.getCourseId()%>"><button class="buttonReopenCourse" type="button">Reopen</button></a>
                                    <%
                                        }
                                    %>
                                </div>
