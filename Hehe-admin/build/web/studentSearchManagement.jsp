                ...
                <div class="container-fluid mt-3">
                    ...
                    <form action="StudentController" method="post">
                        <div class="input-group icons">
                            ...
                            <input type="search" class="form-control" placeholder="Search student" aria-label="Search Dashboard" name="txtSearch">
                                    ...
                                    <div class="active-member">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-xs mb-0">
                                                ...
                                                <tbody>
                                                    <c:forEach var="searchStu" items="${requestScope.searchStu}">



                                                        <tr>
                                                            <td><c:out value="${searchStu.getId()}"></c:out></td>
                                                            <td><c:out value="${searchStu.getFirstName()}"></c:out></td>
                                                            <td><c:out value="${searchStu.getLastName()}"></c:out></td>
                                                            <td><c:out value="${searchStu.getEmail()}"></c:out></td>
                                                            <td><c:out value="${searchStu.getStatus()}"></c:out></td>
                                                            <td><c:out value="${searchStu.getPhoneNumber()}"></c:out></td>


                                                                <td>
                                                                <c:if test="${searchStu.getStatus() == 'Active'}">
                                                                    <c:url var="mylink" value="StudentController">
                                                                        <c:param name="id" value="${searchStu.getId()}"></c:param>
                                                                        <c:param name="status" value="${searchStu.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
                                                                    </c:url>
                                                                    <a class="btn btn-primary" href="${mylink}">Block</a>
                                                                </c:if>
                                                                <c:if test="${searchStu.getStatus() == 'Inactive'}">
                                                                    <c:url var="mylink" value="StudentController">
                                                                        <c:param name="id" value="${searchStu.getId()}"></c:param>
                                                                        <c:param name="status" value="${searchStu.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
