                                                ...
                                                <tbody>
                                                    ...
                                                    <form action="CategoryController" method="POST">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input style="width:100%;border: none;" type="text" name="cateName" value="${cate.getCategoryName()}" required></td>
                                                            <td><input style="width:100%;border: none;"  type="text" name="cateDes" value="${cate.getDescription()}" required></td>
