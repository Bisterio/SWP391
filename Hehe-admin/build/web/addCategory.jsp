            ...
            ***********************************-->
            <div class="content-body">
                <div class="container-fluid mt-3">
                    ...
                    <h1>Add category</h1>
                    <form name="Register" method="POST" action="MainControllerAdmin" id="addCategory">
                        <input hidden="" name="action" value="AddCategory">
                        <input hidden="" name="controller" value="AddCategory">
                        <div class="row">
                            <div class="col-lg-12" >

                                <div class="col-6">
                                    <span class="label-input100">Name <span style="color: red">*</span></span>
                                    <input type="text" name="txtname" class="form-control" placeholder="Category name">
                                </div>
                                <p></p>
                                <div class="col-6">
                                    <span class="label-input100">Description <span style="color: red">*</span></span>
                                    <input type="text" name="txtdescription" class="form-control" placeholder="Category description">
                                </div>
                                <p></p>

                                <div class="col-6">
                                    <input onclick="submit_form('addCategory')" style="position: right" class="btn btn-primary m-1" type="submit" name="action" value="Add category"><br/>
                                </div>
                                <div class="col-6" style="color: red">
                                    ${requestScope.errorCategory}
                                </div>
