                                    ...
                                    <div class="active-member">
                                        <div class="table-responsive">
                                            ...
                                            <table class="table table-xs mb-0">
                                                ...
                                                <tbody>
                                                    <c:forEach var="stu" items="${requestScope.STUDENT_LIST}">
                                                        <tr>
                                                            <td><c:out value="${stu.getId()}"></c:out></td>
                                                            <td><c:out value="${stu.getFirstName()}"></c:out></td>
                                                            <td><c:out value="${stu.getLastName()}"></c:out></td>
                                                            <td><c:out value="${stu.getEmail()}"></c:out></td>
                                                            <td><c:out value="${stu.getStatus()}"></c:out></td>
                                                            <td><c:out value="${stu.getPhoneNumber()}"></c:out></td>


                                                                <td>
                                                                <c:if test="${stu.getStatus() == 'Active'}">
                                                                    <c:url var="mylink" value="StudentController">
                                                                        <c:param name="id" value="${stu.getId()}"></c:param>
                                                                        <c:param name="status" value="${stu.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
                                                                    </c:url>
                                                                    <a class="btn btn-primary" href="${mylink}">Block</a>
                                                                </c:if>
                                                                <c:if test="${stu.getStatus() == 'Inactive'}">
                                                                    <c:url var="mylink" value="StudentController">
                                                                        <c:param name="id" value="${stu.getId()}"></c:param>
                                                                        <c:param name="status" value="${stu.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
