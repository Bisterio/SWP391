                    ...
                    <ul class="metismenu" id="menu">
                        ...
                        <li >
                            ...
                            <a onClick="submit_form('duong')"  aria-expanded="false">
                                <i class="icon-user menu-icon"></i><span class="nav-text">Student</span>
                            </a>
                        </li>
                        <li>
                            ...
                            <a onClick="submit_form('author')" aria-expanded="false">
                                <i class="icon-user menu-icon"></i><span class="nav-text">Author</span>
                            </a>
                        </li>
                        <li>
                            ...
                            <a onClick="submit_form('course')" aria-expanded="false">
                                <i class="icon-user menu-icon"></i><span class="nav-text">Course</span>
                            </a>
                        </li>
                        <li>
                         ...
                         <li>
                            <form  name="ViewCourse"  action="MainControllerAdmin" method="POST" id="studentcourse" aria-expanded="false" >
                            ...
                            <a onClick="submit_form('studentcourse')" aria-expanded="false">
                                <i class="icon-user menu-icon"></i><span class="nav-text">Student in Course</span>
                            </a>
                        </li>
            ...
            <div class="content-body">
                ...
                <div class="container-fluid mt-3">
                   <div style="display: flex; justify-content: space-between" >
                        ...
                        <span>
                        <a class="btn btn-primary" href="registerAuthor.jsp">Add</a>
                        </span>
                    </div>
                    <form action="AuthorController" method="post">
                        <div class="input-group icons">

                            <input type="search" class="form-control" placeholder="Search author" aria-label="Search Dashboard" name="txtSearch">
                                    ...
                                    <div class="active-member">
                                        <div class="table-responsive">
                                            <table class="table table-xs mb-0">
                                                ...
                                                <tbody>
                                                    <c:forEach var="searchAuth" items="${requestScope.searchAuth}">
                                                        <tr>
                                                            <td><c:out value="${searchAuth.getAuthorId()}"></c:out></td>
                                                            <td><c:out value="${searchAuth.getFirstName()}"></c:out></td>
                                                            <td><c:out value="${searchAuth.getLastName()}"></c:out></td>
                                                            <td><c:out value="${searchAuth.getPhoneNumber()}"></c:out></td>
                                                            <td><c:out value="${searchAuth.getStatus()}"></c:out></td>
                                                            <td><c:out value="${searchAuth.getEmail()}"></c:out></td>


                                                                <td>
                                                                <c:if test="${searchAuth.getStatus() == 'Active'}">
                                                                    <c:url var="mylink" value="AuthorController">
                                                                        <c:param name="id" value="${searchAuth.getAuthorId()}"></c:param>
                                                                        <c:param name="status" value="${searchAuth.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
                                                                    </c:url>
                                                                    <a class="btn btn-primary" href="${mylink}">Block</a>
                                                                </c:if>
                                                                <c:if test="${searchAuth.getStatus() == 'Inactive'}">
                                                                    <c:url var="mylink" value="AuthorController">
                                                                        <c:param name="id" value="${searchAuth.getAuthorId()}"></c:param>
                                                                        <c:param name="status" value="${searchAuth.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
