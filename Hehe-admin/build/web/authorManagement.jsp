                                            ...
                                            <table class="table table-xs mb-0">
                                                ...
                                                <tbody>
                                                    <c:forEach var="auth" items="${requestScope.AUTHOR_LIST}">
                                                        <tr>
                                                            <td><c:out value="${auth.getAuthorId()}"></c:out></td>
                                                            <td><c:out value="${auth.getFirstName()}"></c:out></td>
                                                            <td><c:out value="${auth.getLastName()}"></c:out></td>
                                                            <td><c:out value="${auth.getEmail()}"></c:out></td>
                                                            <td><c:out value="${auth.getStatus()}"></c:out></td>
                                                            <td><c:out value="${auth.getPhoneNumber()}"></c:out></td>


                                                                <td>
                                                                <c:if test="${auth.getStatus() == 'Active'}">
                                                                    <c:url var="mylink" value="AuthorController">
                                                                        <c:param name="id" value="${auth.getAuthorId()}"></c:param>
                                                                        <c:param name="status" value="${auth.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
                                                                    </c:url>
                                                                    <a class="btn btn-primary" href="${mylink}">Block</a>
                                                                </c:if>
                                                                <c:if test="${auth.getStatus() == 'Inactive'}">
                                                                    <c:url var="mylink" value="AuthorController">
                                                                        <c:param name="id" value="${auth.getAuthorId()}"></c:param>
                                                                        <c:param name="status" value="${auth.getStatus()}"></c:param>
                                                                        <c:param name="action" value="updateStatusAccount"></c:param>
