...
//else System.out.println("k update duoc");
         //int tmp = new studentInTopics.StudentInTopicDAO().countCompletedTopicsByCourse(11, 6);  
        double tmp = new studentInCourses.StudentInCourseBUS().getCourseProgress(11, 6);
